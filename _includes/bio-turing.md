Ο Alan Turing ήταν άγγλος μαθηματικός που ασχολήθηκε με την κρυπτογραφία και τα εφαρμοσμένα μαθηματικά. Θεωρείται ένας από τους ιδρυτές της σύγχρονης επιστήμηςτων υπολογιστών [^1]. 
